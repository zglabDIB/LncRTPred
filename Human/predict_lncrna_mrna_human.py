...
def make_pred(lnc_m_ind,lnc_mrna_df):
    ...
    filename_1 = 'Models/LNCRNA_MRNA_NORMALIZER_HUMAN.sav'
    filename_2 = 'Models/LNCRNA_MRNA_PCA_HUMAN.sav'
    ...
    model_TR = pickle.load(open('Models/Decision_Tree_HUMAN.sav', 'rb'))
    model_KNN = pickle.load(open('Models/KNN_HUMAN.sav', 'rb'))
    model_RF = pickle.load(open('Models/RF_HUMAN.sav', 'rb'))
    model_LGBM = pickle.load(open('Models/LGBM_HUMAN.sav', 'rb'))
